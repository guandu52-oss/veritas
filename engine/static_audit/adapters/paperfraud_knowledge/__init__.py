...
def _check_study_type(study_type: str, text: str) -> bool:
    ...
    patterns = {
        ...
        "experimental": r"\b(?:cells?|HEK293|HeLa|mice|mouse|rats?|in\s*vivo|in\s*vitro)\b",
    }
...
def summarize_matches(matches: list[RuleMatch]) -> dict:
    ...
    by_severity = {"red": [], "orange": [], "yellow": [], "green": []}
    by_type = {"methodology_review": 0, "fraud_detection": 0}
    ...
    return {
        ...
        "methodology_review_triggered": by_type["methodology_review"],
        "fraud_detection_triggered": by_type["fraud_detection"],
